...
/**
  ...
  /**
   * `prisma.twitchResub`: Exposes CRUD operations for the **TwitchResub** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more TwitchResubs
    * const twitchResubs = await prisma.twitchResub.findMany()
    * ```
    */
  get twitchResub(): Prisma.TwitchResubDelegate<ExtArgs, { omit: OmitOpts }>;

  /**
   * `prisma.twitchGiftSub`: Exposes CRUD operations for the **TwitchGiftSub** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more TwitchGiftSubs
    * const twitchGiftSubs = await prisma.twitchGiftSub.findMany()
    * ```
    */
  get twitchGiftSub(): Prisma.TwitchGiftSubDelegate<ExtArgs, { omit: OmitOpts }>;
}
